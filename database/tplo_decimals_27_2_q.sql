...
CREATE TABLE `tplo_decimals_27_2_q` (
...
insert into `tplo_decimals_27_2_q`(`id`,`value`) values (1,'What is the total mass of the $container with all its contents?
||
...
Mass of the container = ($containerMassRatioNum/$containerMassRatioDenom) x $bookMass = $containerMass kg<br /> 
The total mass of the $container with all its contents is:<br />
$containerMass + ($itemCountTotal x $bookMass) = $massTotal kg
||
$massTotal');
insert into `tplo_decimals_27_2_q`(`id`,`value`) values (2,'Find the total mass of the $container and a $item.
...
Mass of 1 $item = $dMass / $itemCountX = $bookMass kg<br />
Mass of the container = ($containerMassRatioNum/$containerMassRatioDenom) x $bookMass = $containerMass kg<br /> 
The total mass of the $container and one $item is:<br />
